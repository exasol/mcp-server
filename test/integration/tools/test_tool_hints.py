...
def test_tool_hints(pyexasol_connection) -> None:
    ...
    expected_tool_list = {
        ...
        ToolHints(tool_name="describe_exasol_tables_and_views", read_only=True),
        ToolHints(tool_name="describe_exasol_custom_functions", read_only=True),
        ToolHints(tool_name="describe_exasol_user_defined_functions", read_only=True),
