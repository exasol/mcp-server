...
ENV_DYNAMODB_AWS_ACCESS_KEY_ID = "EXA_MCP_OAUTH_DYNAMODB_AWS_ACCESS_KEY_ID"  # nosec
ENV_DYNAMODB_AWS_SECRET_ACCESS_KEY = (
    "EXA_MCP_OAUTH_DYNAMODB_AWS_SECRET_ACCESS_KEY"  # nosec
)
ENV_DYNAMODB_AWS_SESSION_TOKEN = "EXA_MCP_OAUTH_DYNAMODB_AWS_SESSION_TOKEN"  # nosec
...
ENV_REDIS_PASSWORD = "EXA_MCP_OAUTH_REDIS_PASSWORD"  # nosec
