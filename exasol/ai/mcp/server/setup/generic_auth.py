...
ENV_DYNAMODB_AWS_ACCESS_KEY_ID = "EXA_MCP_OAUTH_DYNAMODB_AWS_ACCESS_KEY_ID"  # NOSONAR
ENV_DYNAMODB_AWS_SECRET_ACCESS_KEY = (
    "EXA_MCP_OAUTH_DYNAMODB_AWS_SECRET_ACCESS_KEY"  # NOSONAR
)
ENV_DYNAMODB_AWS_SESSION_TOKEN = "EXA_MCP_OAUTH_DYNAMODB_AWS_SESSION_TOKEN"  # NOSONAR
...
ENV_REDIS_PASSWORD = "EXA_MCP_OAUTH_REDIS_PASSWORD"  # NOSONAR
